...
4: c’est le JavaScript que je vous avais envoyé qui décode le mot de passe. Le JavaScript s’exécute sur ta machine, donc il faut modifier une condition pour débloquer le flag. JavaScript injection.
